...
# split a multivariate sequence into samples, for multivariate(multi-input) multi-step lstm models
...
# split a multivariate sequence into samples, for multivariate(multi-parallel) multi-step lstm models
def split_sequences_multivariate_multistep_ii(sequences, n_steps_in, n_steps_out):
	inputs, outputs = list(), list()
	for i in range(len(sequences)):
		# find the end of this pattern
		end_ix = i + n_steps_in
